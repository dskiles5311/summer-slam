# {{YEAR}} Summer Slam Rules

## #1 — Rules Interpretation

Enforcement of these rules are at the discretion of the Tournament Director and the Tournament Committee. All local, state, and federal laws, rules, and regulations must be obeyed and followed.

## #2 — Participation

Summer Slam is open to all interested anglers. We encourage any and all to participate.

## #3 — Entry Fees

Entry fee is a **${{ENTRY_FEE}} buy in**, in-stock products only of Shimano, G.Loomis, Jackall, and Power Pro.

**Option Pot** — Paid back 100% — **{{OPTION1_PCT}}%** to highest finishing team that enters Option Pot and **{{OPTION2_PCT}}%** to second highest finishing team that enters Option Pot.

## #4 — Sportsmanship

SFT Summer Slam Tournaments require sportsmanship and courtesy to be displayed at all times to fellow competitors, other boaters, property owners, etc. The display of poor sportsmanship or any action detrimental to SFT Summer Slam Tournaments will result in immediate disqualification and possible ban from future events. Verbal intimidation before, during, or following a tournament will not be tolerated.

## #5 — Launch Position

Launch position will be determined by random draw by participant at registration.
...
Cell phones may be used for emergency use only and not for the purpose of locating fish, talking to family, or talking with other contestants (with the exception of a breakdown), etc.
...
Your signature on the entry form states that you agree to a random polygraph examination or Voice Stress Analysis regardless of finish in the tournament.

## #14 — Payout

Summer Slam payout is a minimum of $6,000.00. Payout will increase as size of field increases over 75 boats.

## #15 — Scoring of Bass

Each team may bring in 5 bass with a minimum 15" length.
...
Boaters **must** give another tournament boat a 25-yard perimeter cushion provided they have an anchor/anchor line out and their trolling motor in the stowed position. **Shallow water anchoring systems are not considered an anchor under this rule!** You are not permitted to approach another boat, anchor out or not within 25 yards and drop your anchor forcing them off of a spot. See Rule #4 regarding Sportsmanship.
...
1. **Upper Chesapeake Bay** — The entire western shoreline from Sandy Point to Abbey Point is off limits. The Gunpowder and Bush Rivers that are listed as "Restricted" or "Prohibited" are also Off Limits. It is your responsibility to know the off limits areas as noted on the provided map of "Aberdeen Proving Ground's Restricted Water Zones".

2. **Anchor Marina** — Launching from Anchor Marina, the Off Limits area will be inside the diagonal line (picture on handout morning of tournament) from the fixed fishing pier at the town park to the east (blue house) side of the first canal on the left as you leave the marina. This includes the entire Anchor Marina basin and Nauti Goose docks. No fishing will be permitted inside this area.

3. **Southern Border** — Bobby Point to Shell Point. Middle River and Fairlee Creek are OK.
