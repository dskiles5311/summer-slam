...
export default function SettingsTab({ settings, entries, onUpdateSettings, onClearAll, onImport }) {
      ...
      <div style={{ maxWidth: 640 }}>
        ...
        <div style={PANEL}>
          ...
          <div className="edit-grid-2" style={{ marginBottom: 14 }}>
            <div className="form-field">
              ...
              <input type="number" value={totalPayout} min="0" step="1" inputMode="numeric"
                     onChange={e => setTotalPayout(parseInt(e.target.value) || 0)} />
            </div>
            <div className="form-field">
              <label>Number of Winners</label>
              <input type="number" value={numWinners} min="1" max="100" step="1" inputMode="numeric"
                     onChange={e => setNumWinners(parseInt(e.target.value) || 1)} />
            </div>
          </div>
          <div style={{ display: 'flex', gap: 8, marginBottom: 14, flexWrap: 'wrap' }}>
            <button className="btn btn-primary btn-sm" onClick={handleAutoCalc}>↻ Auto-Calculate</button>
            <button className="btn btn-outline btn-sm" onClick={handleClearPayouts}>Clear Payouts</button>
          </div>
                    ...
                    return (
                      <tr key={i} style={{ borderBottom: '1px solid rgba(139,180,225,0.08)' }}>
                        ...
                        <td style={{ padding: '5px 8px', textAlign: 'right' }}>
                          ...
                          <input type="number" value={amt} min="0" step="1" inputMode="numeric"
        ...
        <div style={PANEL}>
          ...
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
            ...
            <button className="btn btn-danger" onClick={onClearAll}>🗑️ Clear All Data</button>
          </div>
        </div>
        ...
        <div style={PANEL}>
          ...
          <button className="btn btn-outline" style={{ fontSize: 14, padding: '8px 20px' }}
